...
from .models import Event, Org, Location, Tag, Event_Tags, Org_Tags, Event_Media
...
class OrgSerializer(serializers.ModelSerializer):
    org_tags = serializers.PrimaryKeyRelatedField(
        queryset=Org_Tags.objects.all(), many=True)

    class Meta:
        model = Org
        fields = ('pk', 'name', 'email', 'bio', 'photo', 'website',
                  'tags', 'is_staff', 'org_tags', 'is_active')
