...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend_main.Event')),
            ],
        ),
        migrations.CreateModel(
            name='Event_Org',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bio', models.CharField(blank=True, default='', max_length=500)),
                ('website', models.CharField(blank=True, default='', max_length=100)),
                ('photo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='backend_main.Media')),
            ],
        ),
        migrations.AddField(
            model_name='org_tags',
        ...
        migrations.AddField(
            model_name='historicalorg',
            name='photo',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='backend_main.Media'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='event',
            name='media',
            field=models.ManyToManyField(through='backend_main.Event_Media', to='backend_main.Media'),
        ),
        migrations.AddField(
            model_name='event',
            name='tags',
        ...
        migrations.AddField(
            model_name='org_tags',
            name='org_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='org_tags', to='backend_main.Org'),
        ),
        migrations.AddField(
            model_name='org',
            name='tags',
