# Generated by Django 2.1.7 on 2019-10-19 20:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('org', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='app.Org')),
            ],
        ),
        migrations.CreateModel(
            name='Org_Tags',
            fields=[
                ...
                ('org', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                          related_name='org_tags', to='app.Org')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                through='app.Org_Media', to='app.Media'),
        ),
        migrations.AddField(
            model_name='org',
            name='tags',
        ...
        migrations.AddField(
            ...
            name='location',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True,
                                    on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='app.Location'),
        ),
        migrations.AddField(
            model_name='historicalevent',
            name='organizer',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True,
                                    on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='app.Org'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='media',
            field=models.ManyToManyField(
                through='app.Event_Media', to='app.Media'),
        ),
        migrations.AddField(
            model_name='event',
            name='organizer',
        ...
        migrations.AddField(
            ...
            name='tags',
            field=models.ManyToManyField(
                through='app.Event_Tags', to='app.Tag'),
        ),
        migrations.AddField(
