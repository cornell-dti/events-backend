...
=======
# Generated by Django 2.1.7 on 2019-10-16 16:53
>>>>>>> scraper
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('org', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='org_tags', to='app.Org')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
        ...
        migrations.AddField(
            model_name='org',
            name='photo',
            field=models.ManyToManyField(through='app.Org_Media', to='app.Media'),
        ),
        migrations.AddField(
            model_name='org',
            name='tags',
